...
def additional_feature_creation(p_df_trips):
    ...
    p_df_trips["Day_of_year_start"] = p_df_trips["Start Time"].dt.dayofyear
    ...
    p_df_trips["Minute_end"] = p_df_trips["Start Time"].dt.minute
    p_df_trips["Day_of_year_end"] = p_df_trips["End Time"].dt.dayofyear
